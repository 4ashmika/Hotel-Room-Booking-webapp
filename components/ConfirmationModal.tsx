    ...
    >
      <div className="bg-sky-50 rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md m-4 transform transition-all">
        ...
        <div className="bg-sky-100/50 px-6 py-4 rounded-b-2xl flex flex-col sm:flex-row-reverse gap-3">
          <button
            type="button"
            className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-red-500 sm:w-auto sm:text-sm transition-colors"
            onClick={onConfirm}
          >
            Delete
          </button>
